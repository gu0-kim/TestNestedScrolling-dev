...
public class RecyclerViewScrollChild extends RecyclerView implements NestedScrollingChild {
    ...
    public RecyclerViewScrollChild(Context context) {
        this(context, null);
    }

    public RecyclerViewScrollChild(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
