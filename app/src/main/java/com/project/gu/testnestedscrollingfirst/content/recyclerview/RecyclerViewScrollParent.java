...
public class RecyclerViewScrollParent extends LinearLayout implements NestedScrollingParent {
    NestedScrollingParentHelper nsp;
    ImageView iv;
    RecyclerView nsc;
    int ivHeight;

    public RecyclerViewScrollParent(Context context) {
        this(context, null);
    }

    public RecyclerViewScrollParent(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
