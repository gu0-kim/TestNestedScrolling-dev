...
public class AppBarLayoutPullBehavior extends AppBarLayout.Behavior {
    ...
    private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout abl) {
        ...
        if (offsetChildIndex >= 0) {
            ...
            if ((flags & AppBarLayout.LayoutParams.FLAG_SNAP) == AppBarLayout.LayoutParams.FLAG_SNAP) {
                ...
                } else if (checkFlag(flags, AppBarLayout.LayoutParams.FLAG_QUICK_RETURN | AppBarLayout.LayoutParams.SCROLL_FLAG_ENTER_ALWAYS)) {
                ...
                animateOffsetTo(coordinatorLayout, abl, MathUtils.constrain(newOffset, -abl.getTotalScrollRange(), 0), 0);
            }
        }
    }
    ...
    private void updateAppBarLayoutDrawableState(final CoordinatorLayout parent, final AppBarLayout layout, final int offset, final int direction) {
        ...
        if (child != null) {
            ...
            if ((flags & AppBarLayout.LayoutParams.SCROLL_FLAG_SCROLL) != 0) {
                ...
                if (direction > 0 && (flags & (AppBarLayout.LayoutParams.SCROLL_FLAG_ENTER_ALWAYS | AppBarLayout.LayoutParams.SCROLL_FLAG_ENTER_ALWAYS_COLLAPSED)) != 0) {
