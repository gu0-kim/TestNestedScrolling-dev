...
public class MyCoordinatorLayout extends CoordinatorLayout {
    ...
    public MyCoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CoordinatorLayout, defStyleAttr, R.style.Widget_Design_CoordinatorLayout);
    ...
    //         *         *          * LayoutParams instance via {@link LayoutParams#(Behavior)}. It will not be
